...
if __name__ == '__main__':
    ...
    which_output = 'baseline_output'
    parser.add_argument("--mevis_exp_path", type=str, default="/root/MeViS/datasets/mevis/valid_u/meta_expressions.json")
    parser.add_argument("--mevis_mask_path", type=str, default="/root/MeViS/datasets/mevis/valid_u/mask_dict.json")
    parser.add_argument("--mevis_pred_path", type=str, default=f"/root/MeViS/{which_output}/inference")
    parser.add_argument("--save_name", type=str, default=f"/root/MeViS/{which_output}/mevis_test.json")
